...
const ProfileModal = () => {
  ...
  const onSubmit = async (data: ProfileFormData) => {
    ...
    let submitData: { name: string; phone?: string; avatar?: any } = { name };
  ...
  return (
    <ScreenWrapper isModal={true} style={{ paddingTop: 0 }}>
          ...
          <View style={styles.inputContainer}>
            <View style={{ marginTop: spacingY._20, marginBottom: spacingY._20 }}>
              <Typo size={20} fontWeight="900">
                <Text style={{ color: "#6EFF87", letterSpacing: 1 }}>Rider Profile</Text>
                <Text style={{ color: "#FFFFFF" }}> Detail</Text>
              </Typo>
            </View>

            {/* NAME with right pencil */}
            <Typo style={{ paddingLeft: spacingX._10, color: "#FFFFFF" }}>Name</Typo>
            ...
            {errors.name && <Typo style={styles.errorText}>{errors.name.message}</Typo>}
          </View>

          {/* PHONE with right pencil */}
          <View style={{ gap: spacingY._20 }}>
            <View style={styles.inputContainer}>
              <Typo style={{ paddingLeft: spacingX._10, color: "#FFFFFF" }}>Phone</Typo>
              <View style={styles.fieldWrap}>
                <Controller
                  control={control}
                  name="phone"
              ...
              {errors.phone && <Typo style={styles.errorText}>{errors.phone.message}</Typo>}
            </View>
          </View>

          {/* EMAIL (read-only) */}
          <View style={styles.inputContainer}>
            <Typo style={{ paddingLeft: spacingX._10, color: "#FFFFFF" }}>Email</Typo>
            <Controller
              control={control}
              name="email"
              render={({ field: { onChange, onBlur, value } }) => (
            ...
            />
            {errors.email && <Typo style={styles.errorText}>{errors.email.message}</Typo>}
          </View>
          ...
          <View style={styles.logoutWrap}>
            ...
            >
              <View style={styles.logoutRow}>
                ...
                <Typo color={colors.white} fontWeight={"700"} size={16} style={{ marginLeft: 8 }}>
                  Logout
                </Typo>
              </View>
            </Button>
      ...
      {/* Footer kept but divider removed & no update button now */}
...
const styles = StyleSheet.create({
  ...
  footer: {
    ...
    borderTopWidth: 0, // divider removed
  },
  logoutWrap: {
    alignItems: "center",
